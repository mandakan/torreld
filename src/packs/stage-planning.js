...
registerPack({
  ...
  data: {
    ...
    program: {
      ...
      note: "10&ndash;15 min/session. Quality over volume &mdash; a chunk you can't verbalize cleanly doesn't count, reset and run it again. <b>Spend ~70% of the time on Chunk-and-anchor</b>: it attacks the root fault, the rest follows. Keep a stack of printed stage diagrams or WSBs from past matches and <em>rotate which stage you encode each rep</em> &mdash; identical reps lose the contextual-interference benefit."
    },
    drills: {
      lane: "ARM",
      title: "The drills",
      intro: "Each card arms the timer at the bottom with a starting setup. These drills work with a printed stage diagram, a sketch, or your memory of a past stage &mdash; no bay required. The par times are <em>starting values</em> for an intermediate Production Optics shooter; adjust them and log your own.",
      items: [
        {
        ...
        },
        {
          ...
          why: "Mental rehearsal at real stage pace runs the motor program without rounds. The meta-analytic effect is small-to-moderate but additive &mdash; and once the squad moves on from the bay, imagery is the only way to keep putting reps on the integrated plan. Per-position scope keeps the imagery vivid; chain them in real time later.",
          steps: [
            "Stand as you'd enter the position &mdash; gun mounted or holstered as it actually starts, eyes on the entry cue.",
            ...
            "End on the exit-cue moment. If you skipped a target, lost the order, or slipped into slow-motion, the rep doesn't count &mdash; PETTLEP imagery is real-time, full-sensory, gun-in-hand.",
    ...
    evidence: {
      ...
      intro: "Stage planning sits at the seam of perception, memory and motor control &mdash; almost none of it has been studied directly in dynamic pistol. The mapping below draws on the cleanest adjacent literature, with the honest limits at the end.",
      items: [
        { map: "Chunk-and-anchor &middot; Position-snapshot recall", h: "Experts encode in chunks, not impressions", body: "Working memory holds roughly seven independent items at a time; the way experts hold complex configurations (Chase &amp; Simon showed it for chess positions) is to bind elements into <em>chunks</em> they then index by name. A stage encoded as 4&ndash;6 named positions &mdash; each with an entry, an ordered engagement and an exit &mdash; fits the working-memory ceiling. Encoded as one continuous impression, it doesn't." },
        { map: "Eye walk-through &middot; vision-first planning",   h: "Pre-action gaze organises the plan",     body: "In aiming tasks, elite performers show a longer pre-action fixation on the target (the &lsquo;quiet eye&rsquo;), which appears to organise the motor plan and reduce variability. The walk-through is the multi-target version &mdash; pre-anchoring the gaze on every cue you'll need turns the plan into vision. Eyes-only mode is the version that survives a crowded bay." },
        ...
        { map: "Match-day cueing &middot; don't think mechanics on the buzzer", h: "Encode in dry fire, trust on the buzzer", body: "When skilled performers re-direct attention to the mechanics of an autonomous skill under pressure &mdash; consciously deriving step-by-step what should be running automatically &mdash; performance breaks down (re-investment, an explanation for a large fraction of choking). The encoding is built in dry fire so the start-of-stage cue can <em>trigger</em> the plan, not derive it." }
      ],
      caveat: "<b>Honest limit.</b> Chunking and working-memory work is mostly from chess and pattern-recognition; quiet-eye and PETTLEP results are from biathlon, basketball and other aiming sports; re-investment evidence is from lab and golf. Stage planning as a specific motor-cognitive task in dynamic pistol has near-zero direct study. Treat the science as direction, not proof &mdash; let your own match results settle which encoding scheme fits your head."
    },
    references: {
      lane: "SOURCES",
      title: "Research",
      tiers: [
        {
          ...
          items: [
            ...
            { src: "Hwansik Kim",                        grade: "Top GM",           body: "Analytical breakdowns of stage planning &mdash; chunking the stage by position, anchoring the eye, programming the entry and exit. Channel videos free; deeper work inside PSTG classes.", links: [] },
        ...
        },
        {
          ...
          items: [
            { src: "Brian Enos &mdash; forum + Practical Shooting", grade: "Community + book", body: "Practical Shooting: Beyond Fundamentals is the foundational text on visualization and being &lsquo;in the moment&rsquo; on stage; the forum carries decades of practitioner discussion on planning under squad and walk-through constraints.", links: [{ label: "brianenos.com", url: "https://www.brianenos.com/" }] },
            { src: "Lanny Bassham &mdash; With Winning in Mind",      grade: "Olympic champion",  body: "Mental management from an Olympic gold-medal shooter; the lineage behind the &lsquo;visualize the plan, then trust the program&rsquo; mindset taught across practical-shooting coaching. Book, no single link.", links: [] }
          ]
        },
        {
          tier: "Science (peer-reviewed)",
          items: [
            { src: "Chase &amp; Simon (1973) &mdash; Perception in chess",                 grade: "Foundational paper", body: "The original demonstration that expert memory for complex configurations is organised as <em>chunks</em>, recalled by name and far exceeding the working-memory limit on independent items. Direct grounding for the chunk-then-index structure of the primary drill.", links: [{ label: "doi.org", url: "https://doi.org/10.1016/0010-0285(73)90004-2" }] },
            { src: "Vickers (1996) &mdash; Visual control when aiming at a far target", grade: "Foundational paper", body: "Elite performers show a longer pre-action fixation on the target (the &lsquo;quiet eye&rsquo;), which appears to organise the motor plan and reduce variability. Grounding for the eye walk-through.", links: [{ label: "pubmed.ncbi.nlm.nih.gov", url: "https://pubmed.ncbi.nlm.nih.gov/8934848/" }] },
            { src: "Mental practice &mdash; meta-analysis",                              grade: "Meta-analysis",      body: "Mental rehearsal yields a measurable post-acquisition gain (SMD around 0.4). PETTLEP framing (Holmes &amp; Collins 2001) pushes for full-sensory, real-time, in-position imagery &mdash; what the PETTLEP rehearsal drill operationalises.", links: [{ label: "ncbi.nlm.nih.gov/pmc", url: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4714441/" }] },
            { src: "Masters (1992) &mdash; Knowledge, knerves and know-how",             grade: "Foundational paper", body: "Re-direction of attention to the mechanics of an autonomous skill under pressure breaks performance down (re-investment). The argument for building the encoding in dry fire and trusting it on the buzzer rather than deriving the plan on the start signal.", links: [{ label: "doi.org", url: "https://doi.org/10.1111/j.2044-8295.1992.tb02446.x" }] },
            ...
            { src: "Schmidt &amp; Lee &mdash; Motor Learning and Performance",            grade: "Textbook",           body: "Standard reference for the practice-schedule, specificity, feedback and imagery principles above. Book, no single link.", links: [] }
          ]
        }
      ]
    },

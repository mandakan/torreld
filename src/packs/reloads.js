...
registerPack({
  ...
  data: {
    ...
    hero: {
      ...
      lede: "A fast reload isn't fast hands &mdash; it's an <strong>eye-led, indexed motor sequence</strong>. The mag goes where you look; the magwell is a small target. This is a par-time-driven dry-fire program that builds the look-in and the carrier index until the seat happens without thought.",
      readout: { num: "2.00", label: "par &middot; seconds" }
    },
    diagnosis: {
      lane: "CASE",
      title: "The diagnosis behind the program",
      intro: "Slow reloads almost never come from slow hands. They come from <em>breaking the eye-to-mag-to-target chain</em> &mdash; eyes leave the mag too early, the support hand fumbles the index on the carrier, the seat fails or feels uncertain, and the gun stays low while the brain catches up. Fix the vision and the carrier index; the seat and the press-out follow.",
      chain: [
        ...
        {              tag: "Symptom",   title: "Seat",                   body: "Fumbled or unsure insert. ~80% a consequence of poor index and a wandering eye, not slow hands." },
      ...
      notes: {
        ...
        cant: { title: "&#10007; What it doesn't",        body: "Recoil interrupting the reload, the slide closing on a real round under recoil-fatigued grip, and reload performance late in a hard stage. Those need live fire &mdash; ideally inside a stage, not just a static drill." }
      }
    },
    program: {
      lane: "5 SESSIONS",
      ...
      sessions: [
        ...
        { n: "Session 05", primary: false, focus: "Pressure",        items: ["Reload + 1", "Reload under fatigue"] }
      ],
      note: "10&ndash;15 min/session. Quality over volume &mdash; a fumbled rep doesn't count, reset and run it again. <b>Spend ~70% of the time on Index-and-insert</b>: it attacks the root fault, the rest follows."
    },
    drills: {
      lane: "ARM",
      title: "The drills",
      intro: "Each card arms the timer at the bottom with a starting setup. Use dummy mags or empty mags &mdash; never live rounds in dry fire. The par times are <em>starting values</em> for an intermediate Production Optics shooter; adjust them and log your own.",
      items: [
        {
          ...
          why: "The root fault isn't the seat itself &mdash; it's the support-hand index from the carrier and the eye that abandons the mag halfway. Drill the index-then-look-in rep in isolation until the seat is automatic.",
          steps: [
            "Start gun up, aimed at a small reference. Drop the mag with the strong-hand thumb as the gun tilts toward the carrier.",
            "Support hand to the carrier &mdash; index finger flat against the <em>front</em> of the magazine, thumb finds the body of the mag. Same grip every time.",
        ...
        },
        {
          ...
          steps: [
            ...
            "If you caught yourself looking up early, reset &mdash; the rep doesn't count."
          ],
        ...
        },
        {
          ...
          why: "Reloads in matches happen <em>during</em> movement between positions, not standing still. Train the reload that overlaps the leave-and-enter, so no time is paid twice.",
          steps: [
            "Set up in one position. On the beep, break a dry shot, then leave the position.",
            "Reload <em>while moving</em> &mdash; the seat should land before the foot does at the new position.",
        ...
        {
          chips: [{ cls: "cyc", label: "Circuit" }, { cls: "", label: "Pressure &middot; endurance" }],
          title: "Reload under fatigue",
          why: "Late in a stage the support hand is sloppy and the eye gets lazy. The index degrades first; the seat follows. Train the reload in that state, not only when fresh.",
          steps: [
            "Run it late in the session, or after raising your heart rate.",
            "Hold the index and the look-in to the same standard as when fresh.",
            "Stop when quality drops &mdash; not when you could do more."
          ],
          timer: { mode: "circuit", par: "2.2", dmin: "1.5", dmax: "3.0", reps: "12", rest: "3" },
          label: "Reload under fatigue"
        }
      ]
    },
    evidence: {
      ...
      intro: "Most reload advice is practitioner consensus. Where the program leans on motor-learning research, here is the mapping &mdash; and the honest limits.",
      items: [
        { map: "Index-and-insert &middot; magwell as target", h: "Fitts' law: small targets cost time", body: "Movement time to a target grows with distance and shrinks with target width. The magwell is a small target; the reload is a Fittsian aiming task. The fix isn't faster hands &mdash; it's a more repeatable <em>index</em> that reduces the effective distance from carrier to well." },
        ...
        { map: "Index-and-insert &middot; random delay",      h: "Variable practice transfers better", body: "Varying the rep &mdash; random start delay, position changes &mdash; tends to lower practice-day performance but improve retention and transfer to the unpredictable match, versus blocked repetition (the contextual-interference effect)." },
      ...
      caveat: "<b>Honest limit.</b> Fitts' law and the eye-leads-hand finding are robust across simple aiming tasks; neither has been measured specifically in pistol reloads at IPSC speeds. Treat the science as direction, not proof &mdash; let your own timer and target data settle it."
    },
    references: {
      lane: "SOURCES",
      title: "Research",
      tiers: [
        {
          ...
          items: [
            { src: "Practical Shooting Training Group", grade: "World champ / GM",      body: "Stoeger, Hwansik Kim and Joel Park. Analytical reload work, vision/index, and the dry-fire-first philosophy this program is built on. Much is paywalled; the published class videos are the value.", links: [{ label: "practicalshootingtraininggroup.com", url: "https://www.practicalshootingtraininggroup.com" }] },
            { src: "Steve Anderson",                     grade: "USPSA GM",              body: "Refinement and Repetition is the par-time dry-fire program this format mirrors &mdash; reload + 1 is one of its named drills. Plus the podcast That Shooting Show.", links: [{ label: "andersonshooting.com", url: "https://www.andersonshooting.com/product-page/refinement-and-repetition" }] },
        ...
        },
        {
          ...
          items: [
            { src: "Charlie Delta Academy",                   grade: "Explainer",          body: "Plain-language coverage of grip and index that grounds the support-hand mechanics this program builds on for the reload.", links: [{ label: "charliedeltaacademy.com", url: "https://charliedeltaacademy.com/blogs/tips-techniques/fundamentals-part-ii-grip" }] },
            { src: "Brian Enos &mdash; forum + Practical Shooting", grade: "Community + book", body: "Decades of practitioner discussion on reload technique under different divisions and platforms, plus the foundational book Practical Shooting: Beyond Fundamentals.", links: [{ label: "brianenos.com", url: "https://www.brianenos.com/" }] },
            { src: "Lanny Bassham &mdash; With Winning in Mind", grade: "Olympic champion", body: "Mental management from an Olympic gold-medal shooter; the lineage behind the rehearsal-as-practice mindset taught in motor learning. Book, no single link.", links: [] }
          ]
        },
        {
          tier: "Science (peer-reviewed)",
          items: [
            { src: "Fitts (1954) &mdash; The information capacity of the human motor system", grade: "Foundational paper", body: "The original aiming-time law: movement time scales with log<sub>2</sub>(2A/W). The magwell is small (W); a poor carrier index inflates effective distance (A).", links: [{ label: "pubmed.ncbi.nlm.nih.gov", url: "https://pubmed.ncbi.nlm.nih.gov/13174710/" }] },
            ...
            { src: "Schmidt &amp; Lee &mdash; Motor Learning and Performance", grade: "Textbook", body: "The standard reference for the principles above (practice schedule, specificity, feedback, eye-hand coordination). Book, no single link.", links: [] }
          ]
        }
      ]
    },

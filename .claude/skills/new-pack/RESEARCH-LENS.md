...
## 3. External focus of attention beats internal focus

**Principle.** Cueing on the **effect** of the movement (the target, the gun's motion, the dot's trajectory) produces faster learning and better performance than cueing on the **body parts** producing the movement (wrist angle, grip pressure, finger placement). Replicated across hundreds of studies over 25 years (Wulf and colleagues).
...
**Judging question.** Does the source mandate a rigid program with no room for the learner to choose, or does it teach the user to drive their own practice?

**Citation.** Sanli E.A., Patterson J.T., Bray S.R., Lee T.D. (2013). *Understanding self-controlled motor learning protocols through the self-determination theory.* Frontiers in Psychology 3:611. [PubMed 23430980](https://pubmed.ncbi.nlm.nih.gov/23430980/).

---

## 6. Specificity of practice (and the limits of transfer)
...
**Citation.** Specificity & variability of practice review, [PubMed 2094928](https://pubmed.ncbi.nlm.nih.gov/2094928/). And Schmidt & Lee, *Motor Learning and Performance.*
...
## 8. Quiet eye: longer pre-action target fixation → better outcome

**Principle.** In aiming tasks (basketball free throws, biathlon, archery, billiards, pistol target shooting), elite performers show a **longer final fixation on the target** prior to movement initiation. The "quiet eye" period appears to organise the motor plan and reduce variability.

**Design heuristic.** Vision-led drill steps. *"Lock your eyes on a small exact aim point before the gun comes up,"* *"keep your eye on the magwell until you feel the seat,"* *"fix your eyes on an exact point on the target, then close them."* The eye precedes the hand; never the other way round.
...
## 9. Reinvestment theory: don't think mechanics under pressure

**Principle.** When skilled performers re-direct attention to the **mechanics** of an autonomous skill (consciously controlling step-by-step what was being executed automatically), performance breaks down under pressure. This is **re-investment**, and it explains a large fraction of "choking."

**Design heuristic.** Dry fire builds autonomy. Match-day cueing then shifts to **outcome-level** thought (external focus, the target, the plan), not mechanics. The "if you have to think about it under pressure, you haven't drilled it enough" principle. Don't write packs that train the user to inner-monologue through stages.
...
## Numeric heuristics derived from the lens

Use these defaults when designing a pack and override only with reason:
...
| Pre-action vision step | Required | Quiet eye (#8) |

These are **defaults**, not laws. A pack that picks different numbers should say why.

---

## Red flags when reading shooting sources

Pattern-match these against any practitioner advice you cite:

- **"Do 500 reps a day."** Massed practice (against #1), volume past diminishing returns (#7).
- **"Think about your support-hand pressure on every shot."** Internal focus (against #3), risks re-investment under pressure (against #9).
- **"After every rep, score yourself."** Constant KR (against #4); the par beep is doing the job.
- **"Just do exactly this drill until it's automatic."** Blocked repetition (against #2).
- **"Don't look at the target until you're presenting."** Inverts the quiet eye finding (against #8). Vision should lead.
- **"On the start beep, run through your mental checklist."** Conscious mechanics under pressure (against #9).

And green flags:

- Random / variable practice prescriptions.
- Outcome-level / external cueing.
- Par times as feedback, with logging.
...
## Honest limits of the lens

- Almost none of the studies above were run on dynamic pistol shooters. Transfer from laboratory aiming tasks and other sports is **plausible** but not **measured**.
- Some effects (contextual interference especially) are clearer in simple lab tasks than in complex applied skills.
- Effect sizes are typically small-to-moderate. The lens tells you which direction to push; it doesn't tell you the magnitude in this specific sport.
- Practitioner consensus from world-class shooters is itself a form of evidence and sometimes outruns the literature. When the lens and a respected practitioner disagree on a small point, run the timer and the target and let your own data settle it.

The caveat field in every pack's evidence section exists to admit exactly this. Don't oversell the science.
